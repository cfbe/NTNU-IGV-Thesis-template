...
With Python, you can change the size of your figures. This helps get the right size of the text within the figures. In Figure \ref{fig:SizeDiff} we compare two different sizes.
